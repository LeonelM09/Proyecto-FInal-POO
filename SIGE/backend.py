...
if __name__ == "__main__":
    ...
    print("\n1. Probando Usuarios...")
    admin = Usuario(id_usuario="admin01", nombre="Leonel Matos", contraseña="123", rol="Admin", contacto="555-0000")
    exito, msg = admin.registrar_usuario()
    print(f"Resultado Registro: {msg}")
    
    # 2. Prueba de Inicio de Sesión
    print("\n2. Probando Login...")
    #exito_login, rol_login, msg_login = admin.iniciar_sesion("admin01", "123")
    #print(f"Resultado Login: {msg_login}, Rol:{rol_login} (Éxito: {exito_login})")
    exito_login, rol_login, nombre_real = admin.iniciar_sesion("admin01", "123")
    print(f"Resultado Login: {exito_login}, Rol: {rol_login}, Nombre: {nombre_real}")

    # 3. Prueba de Creación de Cliente
    print("\n3. Probando Clientes...")
    cliente1 = Cliente(id_cliente="CL-001", nom_completo="Juan Perez", contacto="555-1234", term_pension="Pensión Básica")
    exito_cli, msg_cli = cliente1.registrar_cliente()
    print(f"Resultado Cliente: {msg_cli}")
    
    # 4. Prueba de Equinos y Matriz de Caballerizas
    print("\n4. Probando Equinos y Mapa de Caballerizas...")
    caballo1 = Equino(id_equino="EQ-001", id_cliente="CL-001", nombre="Relámpago", raza="Pura Sangre", cab_asignada="C-11", etapa_arrendamiento="Iniciación")
    exito_eq, msg_eq = caballo1.registrar_equino()
    print(f"Registro Relámpago (C-11): {msg_eq}")
    
    # 5. Prueba de Validación: Intentar meter otro caballo en la MISMA caballeriza
    print("\n5. Probando Validación de Espacio Ocupado...")
    caballo2 = Equino(id_equino="EQ-002", id_cliente="CL-001", nombre="Tiro al Blanco", raza="Apaloosa", cab_asignada="C-11", etapa_arrendamiento="Avanzado")
    exito_eq2, msg_eq2 = caballo2.registrar_equino()
    print(f"Registro Tiro al Blanco (C-11): {msg_eq2} -> (¡TU LÓGICA FUNCIONA PERFECTO!)")

    print("\n--- PRUEBAS TERMINADAS ---")
    print("¡Revisa tu explorador de archivos! Debería haberse creado 'database_sige.json' y la carpeta 'imagenes_equinos'.")
